...
public class WebUtil {
    ...
    public static void writeJSON(HttpServletResponse response, Object data) {
        try {
            ...
            response.setCharacterEncoding(Constant.UTF_8); // 防止中文乱码
            // 向响应中写入数据
     ...
     */
    public static Params getRequestParamMap(HttpServletRequest request) {
    ...
    public static String getRootPath() {
    	return logger.getClass().getClassLoader().getResource("/").getPath().replace("/WEB-INF/classes/","").replace("file:/","");
    }
}
