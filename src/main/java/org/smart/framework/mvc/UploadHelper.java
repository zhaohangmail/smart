...
import org.smart.framework.mvc.bean.Multipart;
import org.smart.framework.mvc.bean.Multiparts;
import org.smart.framework.mvc.bean.Params;
import org.smart.framework.mvc.fault.UploadException;
    ...
    public static List<Object> createMultipartParamList(HttpServletRequest request) throws Exception {
        ...
        for (FileItem fileItem : fileItemList) {
            ...
            if (fileItem.isFormField()) {
                // 处理普通字段
                String fieldValue = fileItem.getString(Constant.UTF_8);
