...
import org.smart.framework.plugin.PluginProxy;
...
public class AopHelper {
    ...
    private static void addPluginProxy(Map<Class<?>, List<Class<?>>> proxyMap) throws Exception {
        ...
        List<Class<?>> pluginProxyClassList = classScanner.getClassListBySuper(Constant.PLUGIN_PACKAGE, PluginProxy.class);
    ...
    private static void addAspectProxy(Map<Class<?>, List<Class<?>>> proxyMap) throws Exception {
        ...
        // 添加插件包下所有的切面类
        aspectProxyClassList.addAll(classScanner.getClassListBySuper(Constant.PLUGIN_PACKAGE, AspectProxy.class));
        // 排序切面类
